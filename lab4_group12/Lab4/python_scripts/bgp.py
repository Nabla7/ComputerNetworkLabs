...
class SimpleBGP(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        self.addLink(as2ra, as2rc,
                    params1={"ip":"fc00:0:2:ac::a/64"},
                    params2={"ip":"fc00:0:2:ac::c/64"})
        ...
        self.addLink(as2rb, as2rd,
                    params1={"ip":"fc00:0:2:bd::b/64"},
                    params2={"ip":"fc00:0:2:bd::d/64"})
        ...
        self.addLink(as3ra, as3rc,
                    params1={"ip":"fc00:0:3:ac::a/64"},
                    params2={"ip":"fc00:0:3:ac::c/64"})
        ...
        self.addLink(as3rb, as3rd,
                    params1={"ip":"fc00:0:3:bd::b/64"},
                    params2={"ip":"fc00:0:3:bd::d/64"})
        ...
        self.addNetworkCapture(nodes=[as1rb],
                                base_filename="bgp",
                                extra_arguments="-v -i any")
